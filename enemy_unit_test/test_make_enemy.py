...
class TestMakeEnemy(TestCase):
    ...
    def test_make_enemy_player_level_2_no_damage(self, mock_damage, mock_name):
        actual = make_enemy({'level': 2, 'hp': 10, 'xp': 1})
